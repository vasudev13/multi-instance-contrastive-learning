...
class_id = 4 # 0:Cardiomegaly, 1:Edema, 2:Consolidation, 3:Atelectasis, 4:Pleural Effusion 
root = '/scratch/va2134/datasets/CheXpert-v1.0-small/'
      ...
      if idx % 400 == 0:
        ...
        with torch.no_grad():    
              ...
              if best_val_auc < val_auc:
                 ...
                 torch.save(model.state_dict(), '/scratch/va2134/pleural_effusion_model.pth')
              wandb.log({"pleural_effusion_val_auc": val_auc})
